...
public partial class ApplyDaxTemplate : Form
{
    ...
    private static readonly JsonSerializerOptions s_modelChangesOptions = new() { Encoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping, WriteIndented = true };
    ...
    private void ReadConfig_Click(object sender, EventArgs e)
    {
        ...
        var result = SystemJsonSerializer.Serialize(config, s_writeIndentedOptions);
        txtDax.Text = result;
    ...
    private static T ReadConfig<T>(string path) where T : TemplateConfiguration
    {
        ...
        if (SystemJsonSerializer.Deserialize<T>(configJson) is not T config) throw new TemplateConfigurationException("Invalid configuration");
        return config;
    }
    ...
    private CustomDateTemplateDefinition ReadTemplateDefinition()
    {
        ...
        if (SystemJsonSerializer.Deserialize<CustomDateTemplateDefinition>(configJson) is not CustomDateTemplateDefinition config) throw new TemplateConfigurationException("Invalid configuration");
        return config;
    }
    ...
    private Translations.Definitions ReadTranslations()
    {
        ...
        if (SystemJsonSerializer.Deserialize<Translations.Definitions>(translationsJson) is not Translations.Definitions definitions) throw new TemplateConfigurationException("Invalid translations");
        return definitions;
    }
    ...
    private HolidaysDefinitionTable.HolidaysDefinitions ReadHolidaysDefinitionConfig()
    {
        ...
        if (SystemJsonSerializer.Deserialize<HolidaysDefinitionTable.HolidaysDefinitions>(holidaysJson) is not HolidaysDefinitionTable.HolidaysDefinitions holidaysDefinition) throw new TemplateConfigurationException("Invalid configuration");
    ...
    private void MeasureTemplate_Click(object sender, EventArgs e)
    {
        ...
        if (SystemJsonSerializer.Deserialize<MeasuresTemplateDefinition>(templateJson) is not MeasuresTemplateDefinition measuresTemplate) throw new TemplateConfigurationException("Invalid configuration");
    ...
    {
        var result = SystemJsonSerializer.Serialize(modelChanges, s_modelChangesOptions);
        txtDax.Text = result;
    }
    ...
    private void BravoConfig_Click(object sender, EventArgs e)
    {
        ...
        var result = SystemJsonSerializer.Serialize(bravoTemplates, s_writeIndentedOptions);
        txtDax.Text = result;
        #endregion
