...
public class MeasuresTemplateDefinition
{
    ...
    public MeasureTemplate[] MeasureTemplates { get; set; } = [];
}
...
public class MeasuresTemplate
{
    ...
    public string? DisplayFolderRule => Properties.GetValueOrDefault(PROPERTY_DISPLAYFOLDERRULE)?.ToString();
    public string? DisplayFolderRuleSingleInstanceMeasures => Properties.GetValueOrDefault(PROPERTY_DISPLAYFOLDERRULESINGLEINSTANCEMEASURES)?.ToString();
