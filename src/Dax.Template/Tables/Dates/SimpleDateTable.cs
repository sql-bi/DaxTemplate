...
public class SimpleDateTable : BaseDateTemplate<SimpleDateTemplateConfig>
{
    ...
    SELECTCOLUMNS ( 
        ...
        ""{DATE_COLUMN_NAME}"", ''[Date]
            ...
            IgnoreAutoDependency = true,
            Dependencies = [__Calendar]
        };
        DaxStep[] steps = [__Calendar, __RenameCalendar];
        ...
        Hierarchy calendarHierarchy = new()
        {
            Name = "Calendar",
            Levels = [
                new() { Name = "Year", Column = columns.First(c => c.Name == "Year") },
                    new() { Name = "Month", Column = columns.First(c => c.Name == "Year Month") },
                    new() { Name = "Date", Column = Date },
                ]
        };
        Hierarchy fiscalHierarchy = new()
        {
            Name = "Fiscal",
            Levels = [
                new() { Name = "Year", Column = columns.First(c => c.Name == "Fiscal Year") },
                    new() { Name = "Month", Column = columns.First(c => c.Name == "Year Month") },
                    new() { Name = "Date", Column = Date },
                ],
            DisplayFolder = "Fiscal"
